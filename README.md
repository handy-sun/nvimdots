<h1 align="center">
    ...
    <a href="https://github.com/handy-sun/nvimdots/releases">
    <img
        alt="Release"
        src="https://img.shields.io/github/v/release/handy-sun/nvimdots.svg?style=for-the-badge&logo=github&color=F2CDCD&logoColor=D9E0EE&labelColor=363A4F">
    </a>
    ...
    <a href="https://deepwiki.com/handy-sun/nvimdots">
      <img
        alt="Ask DeepWiki"
...
<p align="center">
    <a href="https://github.com/handy-sun/nvimdots/stargazers">
    <img
        alt="Stars"
        src="https://img.shields.io/github/stars/handy-sun/nvimdots?colorA=363A4F&colorB=B7BDF8&logo=adafruit&logoColor=D9E0EE&style=for-the-badge">
    </a>
    <a href="https://github.com/handy-sun/nvimdots/issues">
    <img
        alt="Issues"
        src="https://img.shields.io/github/issues-raw/handy-sun/nvimdots?colorA=363A4f&colorB=F5A97F&logo=github&logoColor=D9E0EE&style=for-the-badge">
    </a>
    <a href="https://github.com/handy-sun/nvimdots/contributors">
    <img
        alt="Contributors"
        src="https://img.shields.io/github/contributors/handy-sun/nvimdots?colorA=363A4F&colorB=B5E8E0&logo=git&logoColor=D9E0EE&style=for-the-badge">
    </a>
    <img
        alt="Code Size"
        src="https://img.shields.io/github/languages/code-size/handy-sun/nvimdots?colorA=363A4F&colorB=DDB6F2&logo=gitlfs&logoColor=D9E0EE&style=for-the-badge">
</p>
...
```pwsh
Set-ExecutionPolicy Bypass -Scope Process -Force; Invoke-Expression ((New-Object System.Net.WebClient).DownloadString('https://raw.githubusercontent.com/handy-sun/nvimdots/HEAD/scripts/install.ps1'))
```
...
if command -v curl >/dev/null 2>&1; then
    bash -c "$(curl -fsSL https://raw.githubusercontent.com/handy-sun/nvimdots/HEAD/scripts/install.sh)"
else
    bash -c "$(wget -O- https://raw.githubusercontent.com/handy-sun/nvimdots/HEAD/scripts/install.sh)"
fi
```

It's strongly recommended to read [Wiki: Prerequisites](https://github.com/handy-sun/nvimdots/wiki/Prerequisites) before starting, especially for \*nix users.
...
<p align="center">See <a href="https://github.com/handy-sun/nvimdots/wiki/Keybindings" rel="nofollow">Wiki: Keybindings</a> for details</p>
<br>

<h3 align="center">
    🔌 Plugins & Deps
</h3>
<p align="center">See <a href="https://github.com/handy-sun/nvimdots/wiki/Plugins" rel="nofollow">Wiki: Plugins</a> for details <br><em>(You can also find a deps diagram there!)</em></p>
<br>

<h3 align="center">
    🔧 Usage & Customization
</h3>
<p align="center">See <a href="https://github.com/handy-sun/nvimdots/wiki/Usage" rel="nofollow">Wiki: Usage</a> for details</p>
<br>

<h3 align="center" id="nixos-support" name="nixos-support">
    ❄️  NixOS Support
</h3>
<p align="center">See <a href="https://github.com/handy-sun/nvimdots/wiki/NixOS-Support" rel="nofollow">Wiki: NixOS Support</a> for details</p>
<br>

<h3 align="center">
    🤔 FAQ
</h3>
<p align="center">See <a href="https://github.com/handy-sun/nvimdots/wiki/Issues" rel="nofollow">Wiki: FAQ</a> for details</p>
...
For more convoluted language, see the [LICENSE](https://github.com/handy-sun/nvimdots/blob/main/LICENSE).
