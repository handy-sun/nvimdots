...
return {
	...
	["n|<leader>iw"] = map_cr("ISwapWith")
		:with_silent()
		:with_noremap()
		:with_desc("iswap: Swap cursor item with another"),
	["n|<leader>ir"] = map_cr("ISwapWithRight")
		:with_silent()
		:with_noremap()
		:with_desc("iswap: Swap cursor item with right"),
	["n|<leader>il"] = map_cr("ISwapWithLeft")
		:with_silent()
		:with_noremap()
		:with_desc("iswap: Swap cursor item with left"),
	["n|<leader>in"] = map_cr("ISwapNode"):with_silent():with_noremap():with_desc("iswap: Swap two adjacent nodes"),
	["n|<leader>iN"] = map_cr("ISwapNodeWith")
		:with_silent()
		:with_noremap()
		:with_desc("iswap: Swap cursor node with another"),
	-- Plugin: iswap.nvim (move)
	["n|<leader>im"] = map_cr("IMove"):with_silent():with_noremap():with_desc("iswap: Interactively move item"),
	["n|<leader>iM"] = map_cr("IMoveWith")
		:with_silent()
		:with_noremap()
		:with_desc("iswap: Move cursor item to another position"),
	...
	["n|<leader>id"] = map_cr("IMoveNode")
		:with_silent()
		:with_noremap()
		:with_desc("iswap: Move node to another position"),
	["n|<leader>iD"] = map_cr("IMoveNodeWith")
		:with_silent()
		:with_noremap()
	...
	["n|sh"] = map_cmd(":setlocal nosplitright<CR>:vsplit <C-R>=GetAbsFileDir()<CR>")
		:with_noremap()
		:with_desc("split left and fill absolute path"),
	["n|sl"] = map_cmd(":setlocal splitright<CR>:vsplit <C-R>=GetAbsFileDir()<CR>")
		:with_noremap()
		:with_desc("split right and fill absolute path"),
	["n|sk"] = map_cmd(":setlocal nosplitbelow<CR>:split <C-R>=GetAbsFileDir()<CR>")
		:with_noremap()
		:with_desc("split above and fill absolute path"),
	["n|sj"] = map_cmd(":setlocal splitbelow<CR>:split <C-R>=GetAbsFileDir()<CR>")
		:with_noremap()
		:with_desc("split below and fill absolute path"),
	...
	["n|z["] = map_cr("exe v:count1 . 'cprevious'")
		:with_noremap()
		:with_silent()
		:with_desc("quickfix: move [count] prev"),
	...
	["c|<C-t>"] = map_cmd("<C-R>=GetAbsFileDir()<CR>")
		:with_noremap()
		:with_silent()
		:with_desc("command: Fill absolute path"),
	-- System clipboard
